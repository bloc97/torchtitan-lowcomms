...
class Trainer(torch.distributed.checkpoint.stateful.Stateful):
    ...
    def __init__(self, job_config: JobConfig):
        ...
        self.optimizers = self.train_spec.build_optimizers_fn(
            self.model_parts, job_config.optimizer, parallel_dims, self.ft_manager, self.world_mesh, job_config.parallelism.force_disable_gradient_all_reduce
        )
    ...
    def train_step(
        ...
        extra_metrics = {
            ...
            "data_metrics/ntokens_seen": self.ntokens_seen,
        }
    ...
    def state_dict(self) -> dict[str, Any]:
        return {"step": self.step, "ntokens_seen": self.ntokens_seen, "trained_tokens": self.trained_tokens}
